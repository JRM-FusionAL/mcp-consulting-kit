...
Add FusionAL (self-hosted MCP governance gateway)

## PR Body

Hi maintainers — adding FusionAL to the gateway/orchestration section.

FusionAL is a self-hosted MCP governance gateway for teams moving from MCP experiments to production.
...
- [ ] Add to the correct section (gateway/orchestration)
- [ ] Keep description factual and concise
- [ ] Confirm repo link resolves
- [ ] Ensure README reflects governance-first framing
